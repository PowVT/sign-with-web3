...
let currentMessageForUseToSign = "**ADDRESS** would like to enter your token protected app, pleaseeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee!";
...
app.post('/', async function(request, response){
    ...
    if(request.body.message != currentMessageForUseToSign.replace("**ADDRESS**", request.body.address)){
        ...
        if(recovered == userAddress){
            ...
            const tokenBalance = mainnetInfura.getBalance(userAddress); 
            if(tokenBalance>0) {
